...
#' #' \itemize{
#' #' \item results.studies = list of data.frames with study results
#' #' \item info.studies = input data.frame with information about studies
#' #' }
#' #'
...
#'             stringsAsFactors = FALSE
#'         )
#'         res$pvalue.adj = p.adjust(res$pvalue, method = "BH")
#'         rownames(res) = res$gene
#'         res.studies[[info.i$id]] = res
#'     }
#'
#'     return(list(res.studies = res.studies,
#'                 info.studies = info.studies[, c("id",
#'                                                 "number.subjects",
#'                                                 "number.samples",
#'                                                 "technology",
#'                                                 "platform")]))
